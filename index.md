...
venue: "RSG México y Colegio de Postgraduados campus Montecillo"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Sala de usos múltiples, Colegio de Postgraduados campus Montecillo, Texcoco, Estado de México"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "Noviembre 27-28, 2015"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "8:00 am - 3:30 pm (UTC-6)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2025-11-27      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2025-11-27        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Aaron Espinosa Jaime", "Mayela Fosado", "Emilio Ortiz", "Mariana Devon"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Andrés Cruz Arredondo", "Camilo Pérez", "Johanna Castelán"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
collaborative_notes:  https://pad.carpentries.org/2025-11-27-Unix_workshop
---
